...
async function humanMouseMove(page, targetX, targetY) {
    ...
    // Przy pierwszym ruchu na nowej stronie - srodek viewportu (naturalna pozycja).
    const viewport = page.viewport();
    const startX = page._lastMouseX ?? (viewport ? viewport.width / 2 : 500);
    const startY = page._lastMouseY ?? (viewport ? viewport.height / 2 : 400);
