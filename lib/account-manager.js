...
class AccountManager {
    ...
    getBrowserOptions(accountConfig, botRole = null, additionalOptions = {}) {
        ...
        const baseOptions = {
            ...
            defaultViewport: null,  // Viewport zarzadzany przez Chrome (--start-maximized)
            ignoreDefaultArgs: ['--enable-automation'],  // Usuwa banner "steruje zautomatyzowane oprogramowanie"
            args: [
                '--no-first-run',
                '--start-maximized',
